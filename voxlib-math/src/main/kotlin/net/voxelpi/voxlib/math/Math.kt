 ...
 */
public fun ceilIntDiv(dividend: Int, divisor: Int): Int {
 ...
 */
public fun interpolateLinear(a: Double, b: Double, t: Double): Double {
    return a + (b - a) * t
}
 ...
 * Linearly interpolates between the points [a] and [b] by [t].
 */
public fun interpolateLinear(a: Vector2D, b: Vector2D, t: Double): Vector2D {
    return a + (b - a) * t
}
 ...
 * Linearly interpolates between the points [a] and [b] by [t].
 */
public fun interpolateLinear(a: Vector3D, b: Vector3D, t: Double): Vector3D {
    return a + (b - a) * t
}
 ...
 */
public fun interpolateExponential(a: Double, b: Double, t: Double): Double {
